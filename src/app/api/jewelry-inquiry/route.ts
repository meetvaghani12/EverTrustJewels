...
export async function POST(request: Request) {
  try {
    ...
    const specs: [string, string][] = [
      ...
      ["Colour", colour],
      ["Metal", metal],
      ["Weight of Diamond", diamondWeight],
    ...
    await sendMail({
      subject: `New Jewellery Inquiry — ${name}`,
      replyTo: email,
      html: `
        <h2>New Jewellery Inquiry</h2>
      ...
      customerHtml: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          ...
          <p>We've received your jewellery inquiry. Our experts will review your requested specification and reach out within 24 hours.</p>
          <h3 style="color:#555;font-size:14px;">Your Requested Specification</h3>
    ...
    console.error("Jewellery inquiry error:", error);
    return NextResponse.json(
